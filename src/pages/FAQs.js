...
const FAQs = () => {
  return (
    <>
      <HelmetDefault title={"FAQs"}></HelmetDefault>
      <div className="container credits">
        <div className="helpful-resources faqs">
          ...
          <ul>
            ...
            <li className="answer">
              MoH data refreshes after scheduled time, the data on this website
              is collected from State Press Bulletins and Reliable news
              channels. The data is verified by volunteers.
            </li>
            ...
            <li className="answer">
              Data is collected from each State Press release, official
              government links and reputable news channel as source. Data is
              validated by group of volunteers and pushed into{" "}
              <a
            ...
            <li className="answer">
              It's all open-source, please feel free to raise a pull-request.
              They are always welcome! <br></br>
              <a
            ...
            <li className="answer">
              Not really. As for the server costs, I had a spare server where
              the API is hosted. The webapp is hosted on Netlify which has a
              decent enough free tier. <br></br>
              <strong>
                If you have some extra cash/resources please consider donating
                to state/central relief funds.
              </strong>
            </li>
