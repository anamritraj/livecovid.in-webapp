      ...
      <div className="helpful-resources faqs">
        ...
        <ul>
          ...
          <li className="answer">
            ...
            collected from State Press Bulletins and Reliable news channels. The data
            is verified by volunteers.
          </li>

          <li className="question">How is the data gathered for this project?</li>
          <li className="answer">
            Data is collected from each State Press release, official government
            links and reputable news channel as source. Data is validated by group of
            volunteers and pushed into{' '}
            <a
          ...
          <li className="answer">
            It's all open-source, please feel free to raise a pull-request. They are
            always welcome! <br />
            <a
          ...
          <li className="answer">
            Not really. As for the server costs, I had a spare server where the API
            is hosted. The webapp is hosted on Netlify which has a decent enough free
            tier. <br />
            <strong>
