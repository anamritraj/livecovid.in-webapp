...
const askUserPermissions = () => new Promise((resolve, reject) => {
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.ready.then((registration) => {
      ...
      registration.pushManager.subscribe(subscribeOptions).then((existingSubscription) => {
...
const sendUnsubscription = (data) => postRequest(`${process.env.REACT_APP_API_URL}/notifications/unsubscribe`, data);
