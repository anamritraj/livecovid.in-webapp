      ...
      <ul>
        ...
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => handleOnclick('telegram')}
            href="https://t.me/livecovidin"
          >
        ...
        <li>
          <a
            ...
            href="https://twitter.com/share?text=Covid-19 India provides the latest state-wise updates on the spread of the coronavirus in India. Stay Informed. Stay Inside!&url=https://livecovid.in"
          >
