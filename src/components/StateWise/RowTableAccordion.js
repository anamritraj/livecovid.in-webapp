...
const sortDistricts = (districtArray, currentOrder, activeSortingKey) =>
  Object.keys(districtArray).sort((a, b) => {
...
const RowTableAccordion = ({
  ...
  const handleSorting = (newActiveSortingKey) => {
    ...
    setDistrictSortOrder(sortDistricts(districts, currentOrder, newActiveSortingKey))
                ...
                {districtSortOrder.map((districtName) => (
                  <tr key={districtName}>
                    ...
                    <td>
                      ...
                      {Number(districts[districtName].confirmed).toLocaleString(
                        'en'
                      )}
                    </td>
                    <td>
                    ...
                    <td>
                      ...
                      {Number(districts[districtName].recovered).toLocaleString(
                        'en'
                      )}
                    </td>
                    <td>
                    ...
                    <td>
                      <BellIcon
                        ...
                        isBellActive={
                          allNotificationsEnabled ||
                          (statesNotificationStatus &&
                            statesNotificationStatus.all === true) ||
                          (statesNotificationStatus &&
                            statesNotificationStatus[districtName]) ||
                          false
                        }
                        isDisabled={
                          allNotificationsEnabled ||
